          ...
          <div className={`space-y-12 transform transition-all duration-1000 ${isVisible.contact ? 'translate-y-0 opacity-100' : 'translate-y-16 opacity-0'}`}>
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-3xl mx-auto">
              {[
                ...
                { icon: Linkedin, label: "LinkedIn", value: "/in/bthomas-tech", href: "www.linkedin.com/in/bthomas-tech" },
                { icon: Github, label: "GitHub", value: "/bolivthom", href: "https://github.com/bolivthom" }
              ].map((contact, index) => (
                <a 
                  key={index}
                  href={contact.href}
